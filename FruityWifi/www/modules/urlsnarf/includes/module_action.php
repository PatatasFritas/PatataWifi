...
if(isset($_GET['service']) and $_GET['service'] == "urlsnarf" and isset($_GET['action'])) {
    if ($_GET['action'] == "start") {
        ...
        // START urlsnarf
		exec_fruitywifi(BIN_URLSNARF." -i $io_action >> $mod_logs &");

    } elseif($_GET['action'] == "stop") {
		// STOP urlsnarf
		exec_fruitywifi(BIN_KILLALL." urlsnarf");
